...
<head>
    <meta charset="utf-8">
    <title>Course Registration Card</title>
...
<?php
$cid=intval($_GET['id']);
$sql=mysqli_query($con,"select course.courseName as courname,course.courseCode as ccode,course.courseUnit as cunit,department.department as dept,courseenrolls.enrollDate as edate,semester.semester as sem ,students.studentName as studentname,students.studentPhoto as photo,students.phone_no as sphone_no,students.StudentEmail as emailid,students.StudentRegno as sregno,students.creationdate as studentregdate from courseenrolls join course on course.id=courseenrolls.course join session on session.id=courseenrolls.session join department on department.id=courseenrolls.department join students on students.StudentRegno=courseenrolls.StudentRegno join semester on semester.id=courseenrolls.semester where courseenrolls.course='$cid'");
$cnt=1;
...
{?>
   ...
   <?php } ?>
                            ...
                            <td>
                               ...
                               <b> Student Email: </b>  <?php echo htmlentities($row['emailid']);?><br>
            ...
            <tr class="item">
             ...
             <tr class="item">
                ...
                <td>
                     <?php echo htmlentities($row['sphone_no']);?>
                </td>
            </tr>
