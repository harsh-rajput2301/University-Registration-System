...
if(isset($_POST['submit']))
{
  ...
  $course=$_POST['course'];
  $sem=$_POST['sem'];
  $ret=mysqli_query($con,"insert into courseenrolls(studentRegno,department,course,semester) values('$studentregno','$dept','$course','$sem')");
  if($ret)
  {
...
<form>
  <input style="background: white; color: white; border: 0;" type="button" value="NULL" onclick="window.location.href='enroll.php'" />
  <input style="background: white; color: white; border: 0;" type="button" value="SE" onclick="window.location.href='enrollse.php'" />
  <input style="background: white; color: white; border: 0;" type="button" value="COE" onclick="window.location.href='enrollcoe.php'" />
</form>
